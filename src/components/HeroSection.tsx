    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden pt-20 md:pt-24">
      ...
      <div className="absolute inset-0 top-20 md:top-24">
        <img
          ...
          className="w-full h-full object-cover object-[20%_20%] md:object-[center_15%] scale-105 animate-[scale-in_20s_ease-out_infinite_alternate] brightness-110"
        />
        {/* Mobile: overlay centered higher, Desktop: overlay on left for Sumi Jo */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_30%_15%,transparent,rgba(0,0,0,0.4)_40%,rgba(0,0,0,0.6))] md:bg-[radial-gradient(ellipse_50%_70%_at_20%_25%,transparent,rgba(0,0,0,0.45)_45%,rgba(0,0,0,0.6))]" />
